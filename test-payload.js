...
// Basic fields
testPayload.append('title', 'Test Announcement');
testPayload.append('content', 'This is a test announcement content');
testPayload.append('type', 'general');
testPayload.append('priority', 'medium');

// Target audience as array (FIXED)
testPayload.append('targetAudience[]', 'all');

// Dates
testPayload.append('publishDate', '2026-03-25');
testPayload.append('expiryDate', '2026-03-31');
